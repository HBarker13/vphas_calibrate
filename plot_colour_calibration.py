...
for ap_rad in range(2,6):
	...
	#plot the counts as a function of shifts
	u_shifts, gmr_shifts = np.meshgrid( u_shifts, gmr_shifts)
	plt.contourf( u_shifts, gmr_shifts, all_hist_sum)
	plt.show()
