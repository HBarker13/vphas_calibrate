...
if not os.path.exists(os.getcwd()+'/'+savename):
	...
	for i in range(1,33): #loop over ccds
		...
		os.system('java -jar /mirror/scratch/hbarker/pkgs/jystilts.jar /home/hbarker/scripts/tmatchn.py {0} {1} {2} {3} {4} {5} {6} {7} {8}'.format(tempfpaths[0], tempfpaths[1], tempfpaths[2], tempfpaths[3], tempfpaths[4], tempfpaths[5], index, match_radius, savename))
